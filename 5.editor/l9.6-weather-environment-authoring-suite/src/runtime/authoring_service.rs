...
pub struct WeatherEnvironmentAuthoringSuite {
    pub(super) next_theater_id: u64,
    pub(super) next_storm_front_id: u64,
    pub(super) theaters: HashMap<TheaterId, ClimateConfig>,
    pub(super) storm_fronts: HashMap<StormFrontId, StormFront>,
    pub(super) theater_storm_fronts: HashMap<TheaterId, Vec<StormFrontId>>,
    pub(super) active_theater: Option<TheaterId>,
}
