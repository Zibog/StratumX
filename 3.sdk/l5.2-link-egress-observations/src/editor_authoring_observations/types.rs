//! Editor authoring observation types
//!
//! Defines the main observation enum for all editor-to-engine data flows.
...
use super::world::{ActorDto, ActorPresetDto, AssetDto, AuthoringSceneDto, EntityDetailsDto, EntityDto};
...
pub enum EditorAuthoringObservation {
    ...
    // Ballistics
    BallisticResult {
        result: crate::vertical_slice_observations::BallisticSimulationResultDto,
    },
    BallisticsEvent {
        event: BallisticsObservation,
    },

    // World/Diagnostics
    WorldTree {
        nodes: Vec<WorldTreeNodeDto>,
    },
    WorldSummary {
    ...
    TerrainBlastResponseInfo {
        crater_radius_m: f32,
        crater_depth_m: f32,
        debris_count: u32,
        ejecta_volume_m3: f32,
    },
    WallIntegritySet {
        integrity: f32,
    },
    ...
    WallDestroyedStateInfo {
        destroyed: bool,
    },
    SupportObjectTypeSet {
        structure_type: String,
    },
    SupportObjectStateInfo {
        structure_type: String,
        integrity: f32,
        destroyed: bool,
        failure_mode: String,
    ...
    ItemTransferredToInventory {
        item_id: u32,
    },
    ItemTransferredToContainer {
        item_id: u32,
    },
    WeaponEquipped {
        item_id: u32,
    ...
    RegionUnloadRequested {
        region_key: (i32, i32, i32),
    },
    RegionUnloadCompleted {
        region_key: (i32, i32, i32),
    },
    MemoryPressure {
        pressure: String,
    ...
    NpcFactionInfo {
        faction_info: Option<(u32, f32, u8)>,
    },
    SquadCreated {
        squad_id: u32,
        member_count: u32,
    ...
    SquadTacticEvaluated {
        reasons: Vec<String>,
    },
    SquadTacticStateInfo {
        tactic_state: String,
    },
    SquadCoverInvalidated {
        reasons: Vec<String>,
    },
    CoverValidityInfo {
        valid: bool,
    ...
    CreatureMigrationEvaluated {
        migration_info: Option<(String, [f32; 3])>,
    },
    CreatureMigrationInfo {
        migration_state: Option<(String, [f32; 3], [f32; 3])>,
    },
    ...
    ReasonChainNpcSlice {
        npc_id: u32,
        entries: Vec<ReasonChainEntryDto>,
    },
    ReasonChainScopeSlice {
        entries: Vec<ReasonChainEntryDto>,
    },
    ReasonTraceStats {
        event_count: usize,
