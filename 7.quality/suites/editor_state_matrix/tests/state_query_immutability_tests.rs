...
mod tests {
    ...
    fn world_identity_strategy() -> impl Strategy<Value = WorldIdentity> {
        (
            ...
            .prop_map(|(uuid, name, path)| WorldIdentity::new(uuid, name, PathBuf::from(path)))
    }
    ...
    fn diagnostic_source_strategy() -> impl Strategy<Value = DiagnosticSource> {
        prop_oneof![
            ...
            Just(DiagnosticSource::ToolingRoute(
                "route.world.open.v1".to_string()
            )),
    ...
    fn test_get_selection_returns_immutable_reference() {
        ...
        session_state
            ...
            .expect("selection setup through public modification API");
