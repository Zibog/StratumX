...
#[cfg(test)]
mod tests {
    use crate::{DockPosition, DockingConfig, PanelGeometry, PanelId, WorkspaceState};
    ...
    fn workspace_state_strategy() -> impl Strategy<Value = WorkspaceState> {
        (
            ...
            .prop_flat_map(|(schema_version, open_panel_ids, docking_config)| {
                ...
                let panel_positions_strategy = panel_positions_for_ids_strategy(open_panel_ids.clone());
            ...
            .prop_map(
                |(schema_version, open_panel_ids, panel_positions, focused_panel, docking_configuration)| {
                    WorkspaceState {
                        schema_version,
                        open_panel_ids,
                        panel_positions,
    ...
    fn docking_config_strategy() -> impl Strategy<Value = DockingConfig> {
        (
            ...
            .prop_map(|(docking_enabled, snap_distance, min_panel_size)| {
                DockingConfig {
                    docking_enabled,
                    snap_distance,
                    min_panel_size,
    ...
    fn test_multiple_panels_round_trip() {
        ...
        let panels = vec![
            (PanelId::new("viewport"), PanelGeometry::floating(0.0, 0.0, 800.0, 600.0)),
            (PanelId::new("outliner"), PanelGeometry::docked(800.0, 0.0, 300.0, 600.0, DockPosition::Right)),
            (PanelId::new("inspector"), PanelGeometry::docked(0.0, 600.0, 1100.0, 300.0, DockPosition::Bottom)),
        ];
