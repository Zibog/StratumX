...
## Required checks for `project_meta_family`
- composition-only legality across project orchestration, governance, and reporting composition, authority-facing minimal truth: project meta refs only, snapshot classes: project-orchestration snapshots
- dependency legality against member contracts
- activation and invalidation propagation for the declared family members

## Operational note
This file remains active and package-specific for `l7.f0-project-meta-family` / `42_TEST_SURFACES.md`.
