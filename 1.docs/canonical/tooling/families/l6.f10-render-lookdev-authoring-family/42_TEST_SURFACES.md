...
## Required checks for `render_lookdev_authoring_family`
- composition-only legality across render lookdev authoring, lighting/look rules, and render previews, authority-facing minimal truth: lookdev edit intents, snapshot classes: lookdev snapshots
- dependency legality against member contracts
- activation and invalidation propagation for the declared family members

## Operational note
This file remains active and package-specific for `l6.f10-render-lookdev-authoring-family` / `42_TEST_SURFACES.md`.
