...
## Required checks for `material_response_authoring_family`
- composition-only legality across material response authoring, reaction tables, and response rule authoring, authority-facing minimal truth: material-response edit intents, snapshot classes: response snapshots
- dependency legality against member contracts
- activation and invalidation propagation for the declared family members

## Operational note
This file remains active and package-specific for `l6.f2-material-response-authoring-family` / `42_TEST_SURFACES.md`.
