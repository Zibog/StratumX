...
## Required checks for `fluid_fire_weather_authoring_family`
- composition-only legality across fluid, fire, weather authoring, field rules, and weather cell authoring, authority-facing minimal truth: fluid/fire/weather edit intents, snapshot classes: fluid/fire/weather snapshots
- dependency legality against member contracts
- activation and invalidation propagation for the declared family members

## Operational note
This file remains active and package-specific for `l6.f5-fluid-fire-weather-authoring-family` / `42_TEST_SURFACES.md`.
