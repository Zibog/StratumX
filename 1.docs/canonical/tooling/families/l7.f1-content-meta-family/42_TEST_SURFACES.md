...
## Required checks for `content_meta_family`
- composition-only legality across content campaign composition and content workflow meta, authority-facing minimal truth: content campaign refs only, snapshot classes: content-campaign snapshots
- dependency legality against member contracts
- activation and invalidation propagation for the declared family members

## Operational note
This file remains active and package-specific for `l7.f1-content-meta-family` / `42_TEST_SURFACES.md`.
