...
|---|---|---|---|
| safety_gate_id | RecordId | stable record identity | unique per record |
...
## Field law
All owned records above must be sufficient to reconstruct the public meaning of `safety_gates` without consulting a hidden mirror.
