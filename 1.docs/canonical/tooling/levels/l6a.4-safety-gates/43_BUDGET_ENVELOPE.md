...
## Budget posture for `safety_gates`
- correctness of `safety_gate_id`, `source_session_id` is non-degradable
...
## Operational note
This file remains active and package-specific for `l6a.4-safety-gates` / `43_BUDGET_ENVELOPE.md`.
