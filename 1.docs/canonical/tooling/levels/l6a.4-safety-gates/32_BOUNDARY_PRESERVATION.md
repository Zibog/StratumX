...
## Preservation rule
`safety_gates` stays valid only while it keeps those classes out.

## Operational note
This file remains active and package-specific for `l6a.4-safety-gates` / `32_BOUNDARY_PRESERVATION.md`.
