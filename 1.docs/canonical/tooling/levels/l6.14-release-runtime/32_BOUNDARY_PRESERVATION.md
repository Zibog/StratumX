...
## Preservation rule
`release_runtime` stays valid only while it keeps those classes out.

## Operational note
This file remains active and package-specific for `l6.14-release-runtime` / `32_BOUNDARY_PRESERVATION.md`.
