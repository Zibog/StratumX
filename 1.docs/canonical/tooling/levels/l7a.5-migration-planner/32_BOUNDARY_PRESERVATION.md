...
## Preservation rule
`migration_planner` stays valid only while it keeps those classes out.

## Operational note
This file remains active and package-specific for `l7a.5-migration-planner` / `32_BOUNDARY_PRESERVATION.md`.
