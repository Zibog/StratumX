...
## Budget posture for `migration_planner`
- correctness of `migration_planner_record_id`, `scope_id` is non-degradable
...
## Operational note
This file remains active and package-specific for `l7a.5-migration-planner` / `43_BUDGET_ENVELOPE.md`.
