...
## Required verification for `world_campaigns`
- invariant tests for `world_campaigns_record_id`, `scope_id`, `state`
...
## Operational note
This file remains active and package-specific for `l7.2-world-campaigns` / `42_TEST_SURFACES.md`.
