...
## Budget posture for `world_campaigns`
- correctness of `world_campaigns_record_id`, `scope_id` is non-degradable
...
## Operational note
This file remains active and package-specific for `l7.2-world-campaigns` / `43_BUDGET_ENVELOPE.md`.
