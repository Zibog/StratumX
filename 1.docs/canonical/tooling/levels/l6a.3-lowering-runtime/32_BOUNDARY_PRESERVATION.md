...
## Preservation rule
`lowering_runtime` stays valid only while it keeps those classes out.

## Operational note
This file remains active and package-specific for `l6a.3-lowering-runtime` / `32_BOUNDARY_PRESERVATION.md`.
