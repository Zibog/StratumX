...
## Budget posture for `lowering_runtime`
- correctness of `lowering_runtime_id`, `source_session_id` is non-degradable
...
## Operational note
This file remains active and package-specific for `l6a.3-lowering-runtime` / `43_BUDGET_ENVELOPE.md`.
