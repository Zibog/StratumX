...
## Preservation rule
`artifact_plane` stays valid only while it keeps those classes out.

## Operational note
This file remains active and package-specific for `l6.6-artifact-plane` / `32_BOUNDARY_PRESERVATION.md`.
