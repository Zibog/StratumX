...
## Budget posture for `assistant_sessions`
- correctness of `assistant_session_id`, `source_session_id` is non-degradable
...
## Operational note
This file remains active and package-specific for `l6a.0-assistant-sessions` / `43_BUDGET_ENVELOPE.md`.
