...
## Preservation rule
`assistant_sessions` stays valid only while it keeps those classes out.

## Operational note
This file remains active and package-specific for `l6a.0-assistant-sessions` / `32_BOUNDARY_PRESERVATION.md`.
