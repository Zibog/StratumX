...
## Required verification for `assistant_sessions`
- invariant tests for `assistant_session_id`, `source_session_id`, `state`
...
## Operational note
This file remains active and package-specific for `l6a.0-assistant-sessions` / `42_TEST_SURFACES.md`.
