...
|---|---|---|---|
| assistant_session_id | RecordId | stable record identity | unique per record |
...
## Field law
All owned records above must be sufficient to reconstruct the public meaning of `assistant_sessions` without consulting a hidden mirror.
