...
## Required verification for `planning_engine`
- invariant tests for `planning_engine_record_id`, `scope_id`, `state`
...
## Operational note
This file remains active and package-specific for `l7a.1-planning-engine` / `42_TEST_SURFACES.md`.
