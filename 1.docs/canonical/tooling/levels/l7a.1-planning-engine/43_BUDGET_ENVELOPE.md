...
## Budget posture for `planning_engine`
- correctness of `planning_engine_record_id`, `scope_id` is non-degradable
...
## Operational note
This file remains active and package-specific for `l7a.1-planning-engine` / `43_BUDGET_ENVELOPE.md`.
