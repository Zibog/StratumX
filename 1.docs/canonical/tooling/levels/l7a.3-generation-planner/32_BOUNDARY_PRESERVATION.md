...
## Preservation rule
`generation_planner` stays valid only while it keeps those classes out.

## Operational note
This file remains active and package-specific for `l7a.3-generation-planner` / `32_BOUNDARY_PRESERVATION.md`.
