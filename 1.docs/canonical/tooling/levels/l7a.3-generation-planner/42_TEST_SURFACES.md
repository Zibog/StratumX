...
## Required verification for `generation_planner`
- invariant tests for `generation_planner_record_id`, `scope_id`, `state`
...
## Operational note
This file remains active and package-specific for `l7a.3-generation-planner` / `42_TEST_SURFACES.md`.
