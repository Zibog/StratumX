...
## Budget posture for `generation_planner`
- correctness of `generation_planner_record_id`, `scope_id` is non-degradable
...
## Operational note
This file remains active and package-specific for `l7a.3-generation-planner` / `43_BUDGET_ENVELOPE.md`.
