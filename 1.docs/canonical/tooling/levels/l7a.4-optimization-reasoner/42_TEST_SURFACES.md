...
## Required verification for `optimization_reasoner`
- invariant tests for `optimization_reasoner_record_id`, `scope_id`, `state`
...
## Operational note
This file remains active and package-specific for `l7a.4-optimization-reasoner` / `42_TEST_SURFACES.md`.
