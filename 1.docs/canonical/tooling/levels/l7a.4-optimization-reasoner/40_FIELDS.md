...
|---|---|---|---|
| optimization_reasoner_record_id | RecordId | stable record identity | unique per published record |
...
## Field law
All owned records above must be sufficient to reconstruct the public meaning of `optimization_reasoner` without consulting a hidden mirror.
