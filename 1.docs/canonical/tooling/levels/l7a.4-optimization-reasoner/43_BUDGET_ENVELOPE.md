...
## Budget posture for `optimization_reasoner`
- correctness of `optimization_reasoner_record_id`, `scope_id` is non-degradable
...
## Operational note
This file remains active and package-specific for `l7a.4-optimization-reasoner` / `43_BUDGET_ENVELOPE.md`.
