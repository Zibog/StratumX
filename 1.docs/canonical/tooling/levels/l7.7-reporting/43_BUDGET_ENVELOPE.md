...
## Budget posture for `reporting`
- correctness of `reporting_record_id`, `scope_id` is non-degradable
...
## Operational note
This file remains active and package-specific for `l7.7-reporting` / `43_BUDGET_ENVELOPE.md`.
