...
## Preservation rule
`reporting` stays valid only while it keeps those classes out.

## Operational note
This file remains active and package-specific for `l7.7-reporting` / `32_BOUNDARY_PRESERVATION.md`.
