...
## Required verification for `reporting`
- invariant tests for `reporting_record_id`, `scope_id`, `state`
...
## Operational note
This file remains active and package-specific for `l7.7-reporting` / `42_TEST_SURFACES.md`.
