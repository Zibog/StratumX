...
## Preservation rule
`stream_plane` stays valid only while it keeps those classes out.

## Operational note
This file remains active and package-specific for `l6.7-stream-plane` / `32_BOUNDARY_PRESERVATION.md`.
