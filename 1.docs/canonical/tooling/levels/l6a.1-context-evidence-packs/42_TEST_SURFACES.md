...
## Required verification for `context_evidence_packs`
- invariant tests for `context_evidence_pack_id`, `source_session_id`, `state`
...
## Operational note
This file remains active and package-specific for `l6a.1-context-evidence-packs` / `42_TEST_SURFACES.md`.
