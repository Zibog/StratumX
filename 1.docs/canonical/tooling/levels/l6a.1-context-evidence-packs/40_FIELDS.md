...
|---|---|---|---|
| context_evidence_pack_id | RecordId | stable record identity | unique per record |
...
## Field law
All owned records above must be sufficient to reconstruct the public meaning of `context_evidence_packs` without consulting a hidden mirror.
