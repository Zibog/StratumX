...
## Preservation rule
`assistant_ui_runtime` stays valid only while it keeps those classes out.

## Operational note
This file remains active and package-specific for `l6a.6-assistant-ui-runtime` / `32_BOUNDARY_PRESERVATION.md`.
