...
|---|---|---|---|
| assistant_ui_runtime_id | RecordId | stable record identity | unique per record |
...
## Field law
All owned records above must be sufficient to reconstruct the public meaning of `assistant_ui_runtime` without consulting a hidden mirror.
