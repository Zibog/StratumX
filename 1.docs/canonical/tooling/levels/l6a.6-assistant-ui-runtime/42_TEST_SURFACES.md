...
## Required verification for `assistant_ui_runtime`
- invariant tests for `assistant_ui_runtime_id`, `source_session_id`, `state`
...
## Operational note
This file remains active and package-specific for `l6a.6-assistant-ui-runtime` / `42_TEST_SURFACES.md`.
