...
## Required verification for `release_campaigns`
- invariant tests for `release_campaigns_record_id`, `scope_id`, `state`
...
## Operational note
This file remains active and package-specific for `l7.4-release-campaigns` / `42_TEST_SURFACES.md`.
