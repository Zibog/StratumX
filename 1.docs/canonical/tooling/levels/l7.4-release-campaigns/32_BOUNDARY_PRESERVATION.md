...
## Preservation rule
`release_campaigns` stays valid only while it keeps those classes out.

## Operational note
This file remains active and package-specific for `l7.4-release-campaigns` / `32_BOUNDARY_PRESERVATION.md`.
