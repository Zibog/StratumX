...
## Preservation rule
`transaction_ledger` stays valid only while it keeps those classes out.

## Operational note
This file remains active and package-specific for `l6.2-transaction-ledger` / `32_BOUNDARY_PRESERVATION.md`.
