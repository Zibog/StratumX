...
## Required verification for `model_request_runtime`
- invariant tests for `model_request_runtime_id`, `source_session_id`, `state`
...
## Operational note
This file remains active and package-specific for `l6a.7-model-request-runtime` / `42_TEST_SURFACES.md`.
