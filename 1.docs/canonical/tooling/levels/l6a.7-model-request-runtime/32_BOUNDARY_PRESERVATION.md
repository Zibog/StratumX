...
## Preservation rule
`model_request_runtime` stays valid only while it keeps those classes out.

## Operational note
This file remains active and package-specific for `l6a.7-model-request-runtime` / `32_BOUNDARY_PRESERVATION.md`.
