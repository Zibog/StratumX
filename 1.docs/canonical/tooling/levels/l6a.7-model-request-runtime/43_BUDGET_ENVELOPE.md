...
## Budget posture for `model_request_runtime`
- correctness of `model_request_runtime_id`, `source_session_id` is non-degradable
...
## Operational note
This file remains active and package-specific for `l6a.7-model-request-runtime` / `43_BUDGET_ENVELOPE.md`.
