...
## Preservation rule
`prompt_understanding` stays valid only while it keeps those classes out.

## Operational note
This file remains active and package-specific for `l7a.0-prompt-understanding` / `32_BOUNDARY_PRESERVATION.md`.
