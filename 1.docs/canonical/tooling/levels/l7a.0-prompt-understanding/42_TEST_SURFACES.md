...
## Required verification for `prompt_understanding`
- invariant tests for `prompt_understanding_record_id`, `scope_id`, `state`
...
## Operational note
This file remains active and package-specific for `l7a.0-prompt-understanding` / `42_TEST_SURFACES.md`.
