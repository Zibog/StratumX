...
|---|---|---|---|
| prompt_understanding_record_id | RecordId | stable record identity | unique per published record |
...
## Field law
All owned records above must be sufficient to reconstruct the public meaning of `prompt_understanding` without consulting a hidden mirror.
