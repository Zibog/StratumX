...
## Budget posture for `prompt_understanding`
- correctness of `prompt_understanding_record_id`, `scope_id` is non-degradable
...
## Operational note
This file remains active and package-specific for `l7a.0-prompt-understanding` / `43_BUDGET_ENVELOPE.md`.
