...
## Required verification for `governance_meta`
- invariant tests for `governance_meta_record_id`, `scope_id`, `state`
...
## Operational note
This file remains active and package-specific for `l7.6-governance-meta` / `42_TEST_SURFACES.md`.
