...
## Budget posture for `governance_meta`
- correctness of `governance_meta_record_id`, `scope_id` is non-degradable
...
## Operational note
This file remains active and package-specific for `l7.6-governance-meta` / `43_BUDGET_ENVELOPE.md`.
