...
## Preservation rule
`governance_meta` stays valid only while it keeps those classes out.

## Operational note
This file remains active and package-specific for `l7.6-governance-meta` / `32_BOUNDARY_PRESERVATION.md`.
