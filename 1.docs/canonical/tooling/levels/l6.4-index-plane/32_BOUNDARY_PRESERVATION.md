...
## Preservation rule
`index_plane` stays valid only while it keeps those classes out.

## Operational note
This file remains active and package-specific for `l6.4-index-plane` / `32_BOUNDARY_PRESERVATION.md`.
