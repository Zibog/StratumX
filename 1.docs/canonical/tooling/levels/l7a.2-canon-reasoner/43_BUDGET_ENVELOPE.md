...
## Budget posture for `canon_reasoner`
- correctness of `canon_reasoner_record_id`, `scope_id` is non-degradable
...
## Operational note
This file remains active and package-specific for `l7a.2-canon-reasoner` / `43_BUDGET_ENVELOPE.md`.
