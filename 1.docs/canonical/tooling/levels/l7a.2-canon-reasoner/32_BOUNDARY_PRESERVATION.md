...
## Preservation rule
`canon_reasoner` stays valid only while it keeps those classes out.

## Operational note
This file remains active and package-specific for `l7a.2-canon-reasoner` / `32_BOUNDARY_PRESERVATION.md`.
