...
## Required verification for `proposal_runtime`
- invariant tests for `proposal_runtime_id`, `source_session_id`, `state`
...
## Operational note
This file remains active and package-specific for `l6a.2-proposal-runtime` / `42_TEST_SURFACES.md`.
