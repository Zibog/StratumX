...
## Budget posture for `proposal_runtime`
- correctness of `proposal_runtime_id`, `source_session_id` is non-degradable
...
## Operational note
This file remains active and package-specific for `l6a.2-proposal-runtime` / `43_BUDGET_ENVELOPE.md`.
