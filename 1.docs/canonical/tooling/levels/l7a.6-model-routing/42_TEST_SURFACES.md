...
## Required verification for `model_routing`
- invariant tests for `model_routing_record_id`, `scope_id`, `state`
...
## Operational note
This file remains active and package-specific for `l7a.6-model-routing` / `42_TEST_SURFACES.md`.
