...
## Budget posture for `model_routing`
- correctness of `model_routing_record_id`, `scope_id` is non-degradable
...
## Operational note
This file remains active and package-specific for `l7a.6-model-routing` / `43_BUDGET_ENVELOPE.md`.
