...
## Required verification for `simulation_campaigns`
- invariant tests for `simulation_campaigns_record_id`, `scope_id`, `state`
...
## Operational note
This file remains active and package-specific for `l7.3-simulation-campaigns` / `42_TEST_SURFACES.md`.
