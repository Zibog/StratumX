...
## Budget posture for `content_campaigns`
- correctness of `content_campaigns_record_id`, `scope_id` is non-degradable
...
## Operational note
This file remains active and package-specific for `l7.1-content-campaigns` / `43_BUDGET_ENVELOPE.md`.
