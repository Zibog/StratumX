...
## Required verification for `content_campaigns`
- invariant tests for `content_campaigns_record_id`, `scope_id`, `state`
...
## Operational note
This file remains active and package-specific for `l7.1-content-campaigns` / `42_TEST_SURFACES.md`.
