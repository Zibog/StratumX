...
## Required verification for `apply_revert_runtime`
- invariant tests for `apply_revert_runtime_id`, `source_session_id`, `state`
...
## Operational note
This file remains active and package-specific for `l6a.5-apply-revert-runtime` / `42_TEST_SURFACES.md`.
