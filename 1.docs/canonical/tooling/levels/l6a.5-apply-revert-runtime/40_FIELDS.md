...
|---|---|---|---|
| apply_revert_runtime_id | RecordId | stable record identity | unique per record |
...
## Field law
All owned records above must be sufficient to reconstruct the public meaning of `apply_revert_runtime` without consulting a hidden mirror.
