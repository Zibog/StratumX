...
## Budget posture for `project_orchestration`
- correctness of `project_orchestration_record_id`, `scope_id` is non-degradable
...
## Operational note
This file remains active and package-specific for `l7.0-project-orchestration` / `43_BUDGET_ENVELOPE.md`.
