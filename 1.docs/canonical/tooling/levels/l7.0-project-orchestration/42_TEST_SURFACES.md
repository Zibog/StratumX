...
## Required verification for `project_orchestration`
- invariant tests for `project_orchestration_record_id`, `scope_id`, `state`
...
## Operational note
This file remains active and package-specific for `l7.0-project-orchestration` / `42_TEST_SURFACES.md`.
