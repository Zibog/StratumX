...
## Preservation rule
`project_orchestration` stays valid only while it keeps those classes out.

## Operational note
This file remains active and package-specific for `l7.0-project-orchestration` / `32_BOUNDARY_PRESERVATION.md`.
