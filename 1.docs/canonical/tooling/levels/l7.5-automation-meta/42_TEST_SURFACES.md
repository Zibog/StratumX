...
## Required verification for `automation_meta`
- invariant tests for `automation_meta_record_id`, `scope_id`, `state`
...
## Operational note
This file remains active and package-specific for `l7.5-automation-meta` / `42_TEST_SURFACES.md`.
