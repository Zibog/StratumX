...
## Budget posture for `automation_meta`
- correctness of `automation_meta_record_id`, `scope_id` is non-degradable
...
## Operational note
This file remains active and package-specific for `l7.5-automation-meta` / `43_BUDGET_ENVELOPE.md`.
