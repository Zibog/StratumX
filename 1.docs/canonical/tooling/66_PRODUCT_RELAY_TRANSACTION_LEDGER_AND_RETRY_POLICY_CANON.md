# Product Relay Transaction Ledger and Retry Policy Canon

**Stack version:** `SX-CANON/1.0.24/STACK-v30`

## Purpose
    This routing contract freezes the tooling execution layer for product relay transaction ledger / retry.
