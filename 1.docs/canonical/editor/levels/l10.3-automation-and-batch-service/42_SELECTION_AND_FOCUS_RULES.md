...
## Rules for `automation_and_batch_service`
- selection and focus are explicit, publishable, and bounded for `batch_run_id`, `batch_recipe_ref`
...
## Operational note
This file remains active and package-specific for `l10.3-automation-and-batch-service` / `42_SELECTION_AND_FOCUS_RULES.md`.
