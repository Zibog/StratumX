...
## Rules for `viewport_system`
- selection and focus are explicit, publishable, and bounded for `viewport_id`, `camera_state_ref`
...
## Operational note
This file remains active and package-specific for `l8.1-viewport-system` / `42_SELECTION_AND_FOCUS_RULES.md`.
