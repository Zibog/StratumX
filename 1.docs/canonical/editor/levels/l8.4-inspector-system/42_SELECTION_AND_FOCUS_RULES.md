...
## Rules for `inspector_system`
- selection and focus are explicit, publishable, and bounded for `inspector_view_id`, `inspected_target_ref`
...
## Operational note
This file remains active and package-specific for `l8.4-inspector-system` / `42_SELECTION_AND_FOCUS_RULES.md`.
