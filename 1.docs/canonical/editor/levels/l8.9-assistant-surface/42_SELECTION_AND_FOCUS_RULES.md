...
## Rules for `assistant_surface`
- selection and focus are explicit, publishable, and bounded for `assistant_surface_id`, `conversation_session_id`
...
## Operational note
This file remains active and package-specific for `l8.9-assistant-surface` / `42_SELECTION_AND_FOCUS_RULES.md`.
