...
## Rules for `production_dashboard_and_traceability`
- selection and focus are explicit, publishable, and bounded for `dashboard_surface_id`, `traceability_view_ref`
...
## Operational note
This file remains active and package-specific for `l11.4-production-dashboard-and-traceability` / `42_SELECTION_AND_FOCUS_RULES.md`.
