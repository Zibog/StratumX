...
## Rules for `editor_shell`
- selection and focus are explicit, publishable, and bounded for `shell_session_id`, `layout_schema_id`
...
## Operational note
This file remains active and package-specific for `l8.0-editor-shell` / `42_SELECTION_AND_FOCUS_RULES.md`.
