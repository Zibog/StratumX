...
## Rules for `simulation_ai_authoring_suite`
- selection and focus are explicit, publishable, and bounded for `simulation_suite_session_id`, `sim_target_scope`
...
## Operational note
This file remains active and package-specific for `l9.5-simulation-ai-authoring-suite` / `42_SELECTION_AND_FOCUS_RULES.md`.
