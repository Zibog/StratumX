...
## Rules for `package_market_and_dependency_service`
- selection and focus are explicit, publishable, and bounded for `package_service_session_id`, `package_listing_ref`
...
## Operational note
This file remains active and package-specific for `l10.7-package-market-and-dependency-service` / `42_SELECTION_AND_FOCUS_RULES.md`.
