...
## Dependency law
The dependency contour above is specific to `package_market_and_dependency_service` and may not be widened by analogy to neighboring levels.
