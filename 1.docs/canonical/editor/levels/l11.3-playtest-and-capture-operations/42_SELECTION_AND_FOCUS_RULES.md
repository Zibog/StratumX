...
## Rules for `playtest_and_capture_operations`
- selection and focus are explicit, publishable, and bounded for `playtest_session_id`, `runtime_bind_ref`
...
## Operational note
This file remains active and package-specific for `l11.3-playtest-and-capture-operations` / `42_SELECTION_AND_FOCUS_RULES.md`.
