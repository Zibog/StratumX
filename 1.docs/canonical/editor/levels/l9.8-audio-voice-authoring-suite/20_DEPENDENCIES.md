...
- content browser
- timeline surface
- tooling audio/acoustics families
...
## Dependency law
The dependency contour above is specific to `audio_voice_authoring_suite` and may not be widened by analogy to neighboring levels.
