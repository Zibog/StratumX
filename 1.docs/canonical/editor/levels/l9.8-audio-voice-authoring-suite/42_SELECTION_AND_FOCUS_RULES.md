...
## Rules for `audio_voice_authoring_suite`
- selection and focus are explicit, publishable, and bounded for `audio_suite_session_id`, `audio_target_ref`
...
## Operational note
This file remains active and package-specific for `l9.8-audio-voice-authoring-suite` / `42_SELECTION_AND_FOCUS_RULES.md`.
