...
- artifact_plane
- validation_runtime
- import-export pipeline service
...
## Dependency law
The dependency contour above is specific to `content_browser_system` and may not be widened by analogy to neighboring levels.
