...
## Rules for `content_browser_system`
- selection and focus are explicit, publishable, and bounded for `content_browser_view_id`, `asset_listing_ref`
...
## Operational note
This file remains active and package-specific for `l8.3-content-browser-system` / `42_SELECTION_AND_FOCUS_RULES.md`.
