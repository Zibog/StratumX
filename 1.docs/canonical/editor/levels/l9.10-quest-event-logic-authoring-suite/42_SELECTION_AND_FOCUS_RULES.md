...
## Rules for `quest_event_logic_authoring_suite`
- selection and focus are explicit, publishable, and bounded for `logic_suite_session_id`, `quest_graph_ref`
...
## Operational note
This file remains active and package-specific for `l9.10-quest-event-logic-authoring-suite` / `42_SELECTION_AND_FOCUS_RULES.md`.
