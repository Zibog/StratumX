...
## Rules for `review_annotation_surface`
- selection and focus are explicit, publishable, and bounded for `review_surface_id`, `annotation_set_ref`
...
## Operational note
This file remains active and package-specific for `l11.1-review-annotation-surface` / `42_SELECTION_AND_FOCUS_RULES.md`.
