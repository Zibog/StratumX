...
## Rules for `ui_hud_authoring_suite`
- selection and focus are explicit, publishable, and bounded for `ui_suite_session_id`, `ui_target_ref`
...
## Operational note
This file remains active and package-specific for `l9.9-ui-hud-authoring-suite` / `42_SELECTION_AND_FOCUS_RULES.md`.
