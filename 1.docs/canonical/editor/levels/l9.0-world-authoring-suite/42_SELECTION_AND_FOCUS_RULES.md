...
## Rules for `world_authoring_suite`
- selection and focus are explicit, publishable, and bounded for `world_suite_session_id`, `cell_view_ref`
...
## Operational note
This file remains active and package-specific for `l9.0-world-authoring-suite` / `42_SELECTION_AND_FOCUS_RULES.md`.
