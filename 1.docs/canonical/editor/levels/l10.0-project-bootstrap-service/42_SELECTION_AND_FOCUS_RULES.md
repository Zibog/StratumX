...
## Rules for `project_bootstrap_service`
- selection and focus are explicit, publishable, and bounded for `bootstrap_request_id`, `project_manifest_ref`
...
## Operational note
This file remains active and package-specific for `l10.0-project-bootstrap-service` / `42_SELECTION_AND_FOCUS_RULES.md`.
