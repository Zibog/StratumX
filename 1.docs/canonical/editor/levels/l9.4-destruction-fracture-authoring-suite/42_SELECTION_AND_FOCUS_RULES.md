...
## Rules for `destruction_fracture_authoring_suite`
- selection and focus are explicit, publishable, and bounded for `destruction_suite_session_id`, `fracture_target_ref`
...
## Operational note
This file remains active and package-specific for `l9.4-destruction-fracture-authoring-suite` / `42_SELECTION_AND_FOCUS_RULES.md`.
