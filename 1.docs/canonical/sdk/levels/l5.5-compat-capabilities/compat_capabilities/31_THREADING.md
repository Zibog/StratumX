# Compatibility Capabilities Local Threading

## Threading law
- single-writer immutable registry with concurrent readers
- no publication reordering across the owning cursor or session
- no mutation of already-published `compat_capabilities` records

## Operational note
This file remains active and package-specific for `compat_capabilities` / `31_THREADING.md`.
