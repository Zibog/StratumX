...
## Sync law
`transport_policies` may synchronize with L4 only through the listed surfaces. Any new surface requires an explicit update to this file and the package dependency model.

## Operational note
This file remains active and package-specific for `l5.8-transport-policies` / `41_L4_SYNC_SURFACES.md`.
