# Transport Policies Local Threading

## Threading law
- single-writer immutable registry
- no publication reordering across the owning cursor or session
- no mutation of already-published `transport_policies` records

## Operational note
This file remains active and package-specific for `transport_policies` / `31_THREADING.md`.
