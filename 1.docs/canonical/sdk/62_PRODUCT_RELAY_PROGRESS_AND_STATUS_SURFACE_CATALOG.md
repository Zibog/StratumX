# Product Relay Progress and Status Surface Catalog
...
## Purpose
    ...
    - ProgressStateObservation
- StatusBarMessageObservation
- StageTransitionObservation
- OperatorFocusHint
    ...
    | Field | Meaning |
|---|---|
| 62_status | ok / degraded / denied / open |
