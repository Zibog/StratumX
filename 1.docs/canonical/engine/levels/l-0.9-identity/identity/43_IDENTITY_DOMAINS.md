...
`Identity Domains` is a canonical element of `engine_identity` inside `L-0.9. Identity Primitives`. It exists as one explicit part of the engine stack and does not transfer its ownership class into another crate or level.

## Data Model

Typed domains separating entity, component, and adjacent identity spaces.
