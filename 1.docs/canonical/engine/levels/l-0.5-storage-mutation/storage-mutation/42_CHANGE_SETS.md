...
Structured mutation packages.

## Canonical Definition

`Change Sets` is a canonical element of `engine_storage_mutation` inside `L-0.5. Storage Mutation`. It exists as one explicit part of the engine stack and does not transfer its ownership class into another crate or level.

## Data Model

Grouped structural and data changes prepared for controlled integration.
