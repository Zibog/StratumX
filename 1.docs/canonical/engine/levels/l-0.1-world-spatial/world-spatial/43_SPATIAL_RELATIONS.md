...
`Spatial Relations` is a canonical element of `engine_world_spatial` inside `L-0.1. World Spatial`. It exists as one explicit part of the engine stack and does not transfer its ownership class into another crate or level.

## Data Model

Adjacency, containment, distance, and relational semantics over spatial entities.
