...
`Context Expansion` is a canonical element of `engine_generation` inside `L3.0. Model Systems`. It exists as one explicit part of the engine stack and does not transfer its ownership class into another crate or level.

## Data Model

Expansion and shaping of inputs into generation-ready structured context.
