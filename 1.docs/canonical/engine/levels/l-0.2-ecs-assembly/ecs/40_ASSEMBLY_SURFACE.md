...
Thin ECS integration surface.

## Canonical Definition

`Assembly Surface` is a canonical element of `engine_ecs` inside `L-0.2. ECS Assembly`. It exists as one explicit part of the engine stack and does not transfer its ownership class into another crate or level.

## Data Model

Minimal assembly-facing surface that binds lower ECS crates into one coherent substrate.
