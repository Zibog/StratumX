...
ECS outward boundary.

## Canonical Definition

`Integration Boundary` is a canonical element of `engine_ecs` inside `L-0.2. ECS Assembly`. It exists as one explicit part of the engine stack and does not transfer its ownership class into another crate or level.

## Data Model

Boundary through which world and runtime consume assembled ECS capabilities.
