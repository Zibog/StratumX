# Runtime First-Result Signature and Text Presentation Canon
...
## Purpose
    ...
    ## Truth objects
    - FirstResultSignature
- TextPresentationState
- LaunchConfirmationState

    ## Runtime phases
    - 1. receive victory state
- 2. render text signature
- 3. confirm signature publication

    ## Ingress and egress carriers
    - FirstResultSignatureObservation

    ## Diagnostics and failure classes
    - SIGNATURE_MISMATCH
- TEXT_PRESENTATION_FAILURE
