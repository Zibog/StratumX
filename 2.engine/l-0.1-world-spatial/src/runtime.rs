//! Spatial coordinate transformations and calculations.

use crate::types::*;
use glam::Vec3;

/// Compute global chunk address from local chunk coordinates within a slab.
...
/// Compute chunk address from world coordinates.
...
/// Compute generic spatial address from world coordinates.
...
/// Compute world-space origin of a region in meters.
...
/// Compute world-space origin of a chunk in meters.
...
/// Compose two transforms (parent-relative local transform into world space).
...
/// Classify spatial relationship between two chunks.
