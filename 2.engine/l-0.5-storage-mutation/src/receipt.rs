...
use crate::{
    ApplyOutcome, ApplyTransactionId, FamilyTag, MutationApplyMode, MutationApplyReport,
    MutationBatchId, MutationFailureReason, MutationOpStatus, RegionTag,
};
...
fn compute_digest(
    ...
    builder.write_u8(mode_code(context.mode));
...
fn mode_code(mode: MutationApplyMode) -> u8 {
    match mode {
        MutationApplyMode::Normal => 1,
        MutationApplyMode::Replay => 2,
        MutationApplyMode::DryRun => 3,
    }
}
